...
from util.RL.GYM_PPO_S_mau.RLTrainer import RLTrainer
# 使用示例
if __name__ == "__main__":
    ...
    training_history = []
    history_save_path = "./results_rl_PPO/training_history.pkl"
    json_save_path = "./results_rl_PPO/training_history.json"
    test_save_path = "./results_rl_PPO/test_results.json"
    test_results = []
